...
//			newResponse.setTitle("Thanh Tai");
			...
			newResponse.setCode("<div class='col-md-3 md-col' style='margin-top: 30px'>"
				...
				+  "<div> <i class='fas fa-home' style='color: white;'>"
				+	newResponse.getTitle()
				+ "</i><span><i style='float: right; color: white;' class='far fa-calendar-alt'>"+newResponse.getS_date()
				+ "</i></span>"
				+	"</div>"
				...
				//TODO
				+	display(newResponse.getImagesEntities())
				+	"</ul>	</div>	</div>	</div>"
				+	"<div class='top-content'>"
				+	"<h5> <a style='color: white;' href='+showDetail?id="+newResponse.getId()+"></a>"
				+	"</h5>	<h5 style='padding: 0px; margin-top: -9px;'>"
				+	"<i class='fas fa-compass' style='color: white;'>"
				+	newResponse.getAddress()+ "</i>	</h5>"
				+	"<h5 style='padding: 0px; margin-top: 4px;'>"
				+	"<i class='fab fa-laravel'	style='color: white; padding: 0px; margin-top: -9px;'>"
				+	newResponse.getArea() +"m<sup>2</sup>"
				+	"</i></h5>	<div class='white'>"
				+	"<a id='luuthongtin' class='hvr-shutter-in-vertical hvr-shutter-in-vertical2'>"
				+	"<springmess:message code='label.savepost' /></a>"
				+	"<a	href='showDetail?id="+newResponse.getId()+"	style='cursor: unset; background: black;' id='xemchitiet'"
				+	"class='hvr-shutter-in-vertical hvr-shutter-in-vertical2'>"
				+	"<springmess:message code='label.showdetail' /> </a>"
				+	"<p class='dollar'>"
				+	"<span>"+newResponse.getPrice()+"</span><span>Triệu</span><span	class='in-dollar'>VNĐ</span>"
...
//			st+="<li><img src=\"getImage/<c:out value='"+imagesEntity.getId()+"'/> \""
